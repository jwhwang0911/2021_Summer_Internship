...
from GetData import dataloader, bag, full_data
...
if __name__ == "__main__":
    ...
    #     exr.write("/rec/pvr1/deep_learning_denoising/test_write/"+"test_input1.exr",
    #                 input_npA
    #                 )
    #     exr.write("/rec/pvr1/deep_learning_denoising/test_write/"+"test_output1.exr",
    #                 output_np
    #                 )
    ...
    for epo in range(500):
        ...
        for item in full_data:
            ...
            if np.mod(index, 5) ==1:
                print('epoch {}, {}/{}, loss is {}'.format(epo, index, len(full_data), iter_loss))

        print('epoch loss = %f'%(epo_loss/len(full_data)))
